...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, color: palette.textMuted, marginBottom: spacing.sm },
  card: {
  ...
  levelLabel: { color: palette.text, fontSize: 15, fontWeight: '800' },
  levelNote: { color: palette.textMuted, fontSize: 12 },
  levelPct: { color: palette.textMuted, fontWeight: '800', fontSize: 14 },
